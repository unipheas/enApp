...
$(document).ready(function(){
  ...
  function shortVowel(picture, word1, word2, word3, audio, wa1, wa2, wa3){
    ...
    $('#word1').on('click', function(){
      new Audio("../audio/short_vowels/mp3/"+wa1).play();
    });
    ...
    $('#word2').on('click', function(){
      new Audio("../audio/short_vowels/mp3/"+wa2).play();
    });
    ...
    $('#word3').on('click', function(){
      new Audio("../audio/short_vowels/mp3/"+wa3).play();
    });
  ...
  function longVowel(pic, word1, word2, word3, audio, tag, wa1, wa2, wa3){
    ...
    $('#word1').on('click', function(){
      new Audio("../audio/long_vowels/mp3/"+wa1).play();
    });
    $('.content p#word2').replaceWith($('<p></p>',{
      class: 'vowelWord',
      id: 'word2',
    ...
    $('#word2').on('click', function(){
      new Audio("../audio/long_vowels/mp3/"+wa2).play();
    });
    $('.content p#word3').replaceWith($('<p></p>',{
      class: 'vowelWord',
      id: 'word3',
    ...
    $('#word3').on('click', function(){
      new Audio("../audio/long_vowels/mp3/"+wa3).play();
    });
    $('.content audio').replaceWith($('<audio></audio>',{
      id: "mp3",
      autoplay: "autoplay",
